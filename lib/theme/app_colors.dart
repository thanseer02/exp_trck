...
class AppColors {
  ...
  static const Color surfaceContainerLowDark = Color(0xFF262626); // Slightly higher
  static const Color surfaceContainerHighDark = Color(0xFF333333); // Even higher

  // Semantics
  static const Color income = Color(0xFF10B981); // Bright green (FlowLedger +12.4%, +$3,200.00)
  static const Color incomeBg = Color(0xFF064E3B); // Dark green container
  static const Color expense = Color(0xFFF3F4F6); // Expenses are white/light gray in the dark design
